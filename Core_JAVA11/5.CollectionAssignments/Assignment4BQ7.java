...
class Parked_CarOwenerList extends Assignment4BQ7{
    int id = 1;
    int levels = 3;
    int sections = 4;
    int slots = 20;
    Map<Integer,Assignment4BQ7> car = new HashMap<>();
    Map<Integer,ParkingSlot> parkingSlotMap = new HashMap<>();

    public void add_new_car(Assignment4BQ7 obj){
    ...
    public void remove_car(String name,int carNo){
        int key = 0;
        for (Map.Entry<Integer, Assignment4BQ7> mp: car.entrySet()){
            Assignment4BQ7 obj = mp.getValue();
...
public class Assignment4BQ7 {
	    ...
	    public void menu(){
	        ...
	        try (Scanner sc = new Scanner(System.in)) {
	            ...
	            do{
	                ...
	                choice = sc.nextInt();
	                switch (choice){
	                    case 1: parked_carOwenerList.add_new_car(new Assignment4BQ7());
	                            break;
	                    case 2: String name;
	                    int number;
    ...
    public static void main(String[] args) {
        Assignment4BQ7 obj = new Assignment4BQ7();
        obj.menu();
    }
}
